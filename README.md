...
| 模块 | 功能 | 许可证 |
|------|------|--------|
| **p2p** | P2P 直连传输，高速去中心化 | GPL-3.0 |
| **tor** | Tor 匿名网络，隐私保护 | AGPL-3.0 |
| **i2p** | I2P 隧道加密，适合内部服务 | AGPL-3.0 |
| **crdt** | 无冲突同步，多设备自动合并 | 商业授权 |
...
| 组件 | 许可证 | 说明 |
|------|--------|------|
| Core | Apache 2.0 | 允许商业使用 |
| 基础模块（p2p/tor/i2p）| GPL v3 / AGPL v3 | 传染性开源 |
| 高级模块（crdt）| 商业授权 | Open Core 商业模式 |
| UI 层 | MIT | 基础版开源 |
| Crypto 模块 | Apache 2.0 | 允许商业使用 |
